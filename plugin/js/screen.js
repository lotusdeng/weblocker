...
function getPositions(callback) {
	...
	//chrome.storage.local.get('pictureFormat', function(result) {
	//   if(result.pictureFormat.length != 0) {
	//   	   pictureFormat = result.pictureFormat;
	//   }
	//});
	
    //alert("getPositions start");
    var body = document.body,
        widths = [
            document.documentElement.clientWidth,
            document.body.scrollWidth,
